...
class RegisterCertificatePassthroughClientTest {
  ...
  void shouldNotCreateProxyWhenConfigIsNull() {
    final var props = new PassthroughProperties(null, null);
  ...
  void shouldReturnEmptyWhenConfigIsNull() {
    final var client =
        new RegisterCertificatePassthroughClient(new PassthroughProperties(null, null), factory);
  ...
  private PassthroughProperties propsWithEnabled(boolean enabled) {
    ...
    return new PassthroughProperties(null, config);
  }
