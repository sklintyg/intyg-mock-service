...
class RevokeCertificatePassthroughIT extends AbstractPassthroughIT {
  ...
  private static final String SOAP_OK_RESPONSE =
      ...
      <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
          xmlns:ns5="urn:riv:clinicalprocess:healthcond:certificate:RevokeCertificateResponder:2"
          xmlns:ns2="urn:riv:clinicalprocess:healthcond:certificate:v3">
        <soapenv:Header/>
        <soapenv:Body>
          <ns5:RevokeCertificateResponse>
            <ns2:result>
  ...
  void shouldForwardToUpstreamAfterStoringLocally() throws IOException {
    postSoap(SOAP_PATH, "soap/revoke-certificate.xml");
  ...
  void shouldReturnErrorWhenUpstreamFails() throws IOException {
    ...
    final var body =
        new ClassPathResource("soap/revoke-certificate.xml")
    ...
    final var stored = restTemplate.getForEntity(REST_PATH, RevokeCertificateDTO[].class);
