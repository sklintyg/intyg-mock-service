...
public class CertificateStatusUpdateForCareRepository {
    ...
    public void add(String logicalAddress, CertificateStatusUpdateForCareType certificateStatusUpdateForCareType) {
        repository.computeIfAbsent(logicalAddress, k -> new ArrayList<>()).add(certificateStatusUpdateForCareType);
    }
