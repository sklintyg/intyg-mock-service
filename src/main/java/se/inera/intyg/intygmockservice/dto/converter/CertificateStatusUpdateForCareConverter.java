package se.inera.intyg.intygmockservice.dto.converter;
...
public class CertificateStatusUpdateForCareConverter {
    ...
    private CertificateStatusUpdateForCareDTO.Fragor convertFragor(se.riv.clinicalprocess.healthcond.certificate.v3.Arenden source) {
